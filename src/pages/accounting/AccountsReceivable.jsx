...
function AccountsReceivable() {
    ...
    const loadData = () => {
        setArData(getAccountsReceivable())
    }
    ...
    const overdueAmount = arData.reduce((sum, item) => {
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
                <div className="stats-row">
                    ...
                    <div className="stat-card">
                        ...
                        <div className="stat-value">{arData.length}</div>
                    </div>
                </div>

                <DataTable columns={columns} data={arData} searchable exportable />
            </motion.div>
